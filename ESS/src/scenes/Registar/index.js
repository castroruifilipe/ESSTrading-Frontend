		...
		return (
			<div>
				<Form className="form-signin" onSubmit={this.onSubmit}>
					...
					<Input required value={first_name} placeholder="Primeiro nome" type="text" className="form-control"
						onChange={event => this.setState({
							'first_name': event.target.value
						})}
					/>
					<Input required value={last_name} placeholder="Último nome" type="text" className="form-control"
						onChange={event => this.setState({
							'last_name': event.target.value
						})}
					/>
					<Input required value={username} placeholder="Username" type="text" className="form-control"
						onChange={event => this.setState({
					...
					/>
					<Input required value={password_one} placeholder="Password" type="password" className="form-control"
						onChange={event => this.setState({
							'password_one': event.target.value
						})}
					/>
					<Input required value={password_two} placeholder="Confirmar password" type="password" className="form-control"
						onChange={event => this.setState({
							'password_two': event.target.value
						})}
					/>
					<Input value={contacto} placeholder="Contacto" type="tel" className="form-control"
						onChange={event => this.setState({
